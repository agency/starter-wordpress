<div class="payments-form-wrap" data-payments-form>
	...
	<form class="payments-form" action="/" method="post">
		...
		<div class="footer-navigation">
			...
			<a href="#prev" data-payment-control="prev" style="display:none;" role="button" aria-label="Go to previous step">Prev</a>
			<a href="#next" data-payment-control="next" role="button" aria-label="Go to next step">Next</a>
